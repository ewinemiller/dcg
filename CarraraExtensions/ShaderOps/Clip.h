...
struct ClipPublicData{
	TVector2 vec2Clip;
	TMCCountedPtr<IShParameterComponent> param;	
	};

//MCDEFINE_GUID2(CLSID_Clip, R_CLSID_Clip);
extern const MCGUID CLSID_Clip;


class Clip : public TBasicShader {
	public:
		Clip();
		STANDARD_RELEASE;
		virtual int32   MCCOMAPI GetParamsBufferSize    ()
			const        { return sizeof(ClipPublicData); }
