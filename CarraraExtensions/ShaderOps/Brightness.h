...
struct BrightnessPublicData{
	real32 fBrightness;
	TMCCountedPtr<IShParameterComponent> param;	
	};

//MCDEFINE_GUID2(CLSID_Brightness, R_CLSID_Brightness);
extern const MCGUID CLSID_Brightness;

 
class Brightness : public TBasicShader {
	public:
		Brightness();
		STANDARD_RELEASE;
		virtual int32   MCCOMAPI GetParamsBufferSize    ()
			const        { return sizeof(BrightnessPublicData); }
