...
struct UVTilePublicData{
	real32 fUTile;
	real32 fVTile;
	TMCCountedPtr<IShParameterComponent> param;	
	};

//MCDEFINE_GUID2(CLSID_UVTile, R_CLSID_UVTile);
extern const MCGUID CLSID_UVTile;


class UVTile : public TBasicShader {
	public:
		UVTile();
		STANDARD_RELEASE;
		virtual int32   MCCOMAPI GetParamsBufferSize    ()
			const        { return sizeof(UVTilePublicData); }
