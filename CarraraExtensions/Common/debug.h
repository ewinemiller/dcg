...
{
	DoAlert(EAlerts alertSeverity,			// Alert severity icon. See kShNotificationAlert, kShCautionAlert and kShStopAlert constants
		kShNotificationAlert,	// Main message to display
		kNullString, 
		kNullString,
		kNullString,			// Substitution strings : any "^0", "^1" and "^2" token in 'mainMessage' will be replaced by 'arg0', 'arg1', and 'arg2'
		kOneButton,			// Number of buttons (1, 2 or 3)
