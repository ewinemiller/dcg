...
class cMeshBucket:public IMeshTree {
	public:
		cMeshBucket();
		~cMeshBucket();

		void FindClosestNode(IMeshTree** node, const TVector3& point, meshTreeCallLocalStorage& callLocalStorage);
		MCCOMErr enumSiblings(IMeshTree* node, IMeshTree** sibling, meshTreeCallLocalStorage& callLocalStorage);
