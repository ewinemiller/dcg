...
*/
#ifndef __AnimatedMixer__
#define __AnimatedMixer__
...
#include "ControllingOpHelper.h"

extern const MCGUID CLSID_AnimatedMixer;

class AnimatedMixer : public ControllingOpHelper<ControllingOpPublicData>
{
	public:
		AnimatedMixer() 
		{
