...
*/
#ifndef __MultiAccumulate__
#define __MultiAccumulate__
...
extern const MCGUID CLSID_MultiAccumulate;
 
class MultiAccumulate : public MultiOpHelper<MultiOpPublicData>
{
	public:
		MultiAccumulate() {};
		~MultiAccumulate() {};
