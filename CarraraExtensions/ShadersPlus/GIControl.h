...
*/
#ifndef __GIControl__
#define __GIControl__
...
//MCDEFINE_GUID2(CLSID_GIControl, R_CLSID_GIControl);
extern const MCGUID CLSID_GIControl;


class GIControl : public TBasicShader 
{
	public:
		GIControl();
		STANDARD_RELEASE;
		virtual int32   MCCOMAPI GetParamsBufferSize    ()
			const        { return sizeof(GIControlPublicData); }
