...
int coplanar_tri_tri(float N[3],const float V0[3],const float V1[3],const float V2[3],
...
inline void isect2(const float VTX0[3],const float VTX1[3],const float VTX2[3],float VV0,float VV1,float VV2,
...
inline int compute_intervals_isectline(const float VERT0[3],const float VERT1[3],const float VERT2[3],
...
int tri_tri_intersect_with_isectline(const float V0[3],const float V1[3],const float V2[3],
				     const float U0[3],const float U1[3],const float U2[3],int *coplanar,
				     float isectpt1[3],float isectpt2[3])
{
  float E1[3],E2[3];
  float N1[3],N2[3],d1,d2;
