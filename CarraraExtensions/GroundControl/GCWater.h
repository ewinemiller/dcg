...
extern const MCGUID CLSID_GCWater;


class GCWater : public TBasicShader {
	public:
		GCWater();
		STANDARD_RELEASE;
		...
		virtual int32   MCCOMAPI GetParamsBufferSize    ()
			const        { return sizeof(GCWaterPublicData); }
