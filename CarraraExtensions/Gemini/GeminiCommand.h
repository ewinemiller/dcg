...
//MCDEFINE_GUID2( CLSID_AGrGeminiCommand, R_CLSID_AGrGeminiCommand );
extern const MCGUID CLSID_GeminiCommand;

struct GeminiCommandData {
	int32 lKeep;
	real32 fMargin;
	boolean bKeepOriginal;
	};

#if (VERSIONNUMBER >= 0x030000)
class GeminiMenuPreparer : public TBasicMenuCallBack
{
public:
...
// SceneOp Object :
class GeminiCommand : public TBasicSceneCommand
{
	public :  
		GeminiCommand();
		STANDARD_RELEASE;
		...
		virtual int32   MCCOMAPI GetParamsBufferSize    ()
			const        { return sizeof(GeminiCommandData); }
	...
	private :
		GeminiCommandData				fData;					// Scene Operation Data
